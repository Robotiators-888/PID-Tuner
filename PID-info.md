...
The P value is the proportional part of it and it controls the "speed" but it will never actually get the error to 0. It is a constant offset based on how far you are from the goal at the current momment and is proportional to the error.\
